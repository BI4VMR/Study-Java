...
include(":M03_Advance:C03_DataStructure:S01_Base")
include(":M03_Advance:C04_MultiTask:S01_Thread")
include(":M03_Advance:C04_MultiTask:S02_Tool")
...
include(":M04_Utils:C04_DataParse:S01_GSON")
include(":M04_Utils:C05_Test:S01_Base")
include(":M04_Utils:C05_Test:S02_JUnit4")
include(":M04_Utils:C05_Test:S02_JUnit5")
include(":M04_Utils:C05_Test:S03_Mockito")
